...
<ul class="nav flex-column">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch02.</span><a class="text-white" href="${pageContext.request.contextPath}/ch02/content">Controller/RequestMapping</a>
		</h6> 
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch013.</span><a class="text-white" href="${pageContext.request.contextPath}/ch13/content">DI(Dependency Injection)</a>
		</h6> 
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch014.</span><a class="text-white" href="${pageContext.request.contextPath}/ch14/content">DAO(Data Access Object)</a>
		</h6> 
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch016.</span><a class="text-white" href="${pageContext.request.contextPath}/ch16/content">Transaction</a>
		</h6> 
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch017.</span><a class="text-white" href="${pageContext.request.contextPath}/ch17/content">Security</a>
		</h6> 
	</li>
